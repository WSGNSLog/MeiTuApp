...
- (void)setupSlider
{
    ...
    _saturationSlider.superview.center = CGPointMake(self.editor.bottomView.width/2, self.editor.bottomView.top-30);
    ...
    _contrastSlider.superview.center = CGPointMake(self.editor.bottomView.width-20, _brightnessSlider.superview.center.y);
...
- (void)sliderDidChange:(UISlider*)sender
{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        [self.editor performSelectorOnMainThread:@selector(setShowImage:) withObject:image waitUntilDone:NO];
        inProgress = NO;
    });
}
