...
- (void)setup
{
    ...
    CGSize imgVSize = self.editor.imageRect.size;
    _drawingView = [[UIImageView alloc] initWithFrame:(CGRect){self.editor.imageView.center.x-imgVSize.width/2,self.editor.imageView.center.y-imgVSize.height/2,imgVSize}];
    _drawingView = [[UIImageView alloc] initWithFrame:(CGRect){self.editor.imageView.center.x-imgVSize.width/2,self.editor.imageView.center.y-imgVSize.height/2,imgVSize}];
